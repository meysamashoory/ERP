...
4. در مرورگر کلاینت‌ها باز کنید:
   ...
   http://planning.poliran:8000/
   ```
5. اگر می‌خواهید **بدون `:8000`** باشد (`http://planning.poliran/`)، باید روی سرور پورت ۸۰ استفاده شود
   (مثلاً با IIS / nginx به‌عنوان reverse proxy، یا اجرای سرویس روی پورت ۸۰ با دسترسی Administrator).
